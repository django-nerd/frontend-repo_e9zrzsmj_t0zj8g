...
// Decorative, privacy-friendly gradient blobs with subtle parallax via CSS only.
// No external images, no network requests, no storage.
export default function DecorativePhotos() {
  ...
  // Each blob uses a CSS gradient. Slight transforms create depth.
  return (
    <>
      {/* Top-left */}
      <div
        ...
        aria-hidden
        style={{
          background: 'radial-gradient(120% 120% at 30% 30%, rgba(125,211,252,0.35) 0%, rgba(59,130,246,0.25) 45%, rgba(15,23,42,0.0) 80%)',
          filter: 'blur(2px)'
        }}
      />
      ...
      <div
        ...
        aria-hidden
        style={{
          background: 'radial-gradient(110% 110% at 70% 30%, rgba(99,102,241,0.35) 0%, rgba(168,85,247,0.28) 50%, rgba(15,23,42,0.0) 78%)',
          filter: 'blur(3px)'
        }}
      />
      ...
      <div
        ...
        aria-hidden
        style={{
          background: 'radial-gradient(130% 130% at 40% 60%, rgba(34,197,94,0.32) 0%, rgba(16,185,129,0.26) 45%, rgba(15,23,42,0.0) 80%)',
          filter: 'blur(4px)'
        }}
      />
      ...
      <div
        ...
        aria-hidden
        style={{
          background: 'radial-gradient(120% 120% at 60% 70%, rgba(251,191,36,0.30) 0%, rgba(244,114,182,0.26) 48%, rgba(15,23,42,0.0) 78%)',
          filter: 'blur(6px)'
        }}
      />
      ...
      <div
        ...
        aria-hidden
        style={{
          background: 'radial-gradient(120% 120% at 40% 70%, rgba(56,189,248,0.32) 0%, rgba(34,211,238,0.26) 45%, rgba(15,23,42,0.0) 78%)',
          filter: 'blur(8px)'
        }}
      />
    </>
